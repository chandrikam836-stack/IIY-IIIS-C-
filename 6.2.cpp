...
// Display     void display() const {         
cout << "Value: " << value << endl;  
}  
// Friend function for unary operator (-)     
friend Number operator-(const Number &n);     // 
Friend function for binary operator (+)     friend
Number operator+(const Number &n1, const Number 
&n2);  
};  
...
n3 = -n1;  
// Negation using friend function     n3.display();     cout 
